...
exports.getMovements = exports.getAccountDetails = void 0;
var _axios = _interopRequireDefault(require("axios"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var url = "".concat("http://localhost:3000/api", "/movements");
var urlAccount = "".concat("http://localhost:3000/api", "/account-list");
...
var getAccountDetails = function getAccountDetails(id) {
  return _axios.default.get("".concat(urlAccount, "/").concat(id)).then(function (response) {
    return response.data;
  });
};
...
(0, _movements.getMovements)(params.id).then(function (apiMovements) {
  ...
  var movements = (0, _movements3.mapMovementsListFromApiToViewModel)(apiMovements);
  (0, _movements2.addMovementRows)(movements);
});
(0, _movements.getAccountDetails)(params.id).then(function (account) {
  document.getElementById('alias').innerHTML = account.name;
  document.getElementById('iban').innerHTML = account.iban;
  document.getElementById('balance').innerHTML = "".concat(account.balance, " \u20AC");
});
},{"./movements.api":"pages/movements/movements.api.js","../../core/router":"core/router/index.js","./movements.helpers":"pages/movements/movements.helpers.js","./movements.mappers":"pages/movements/movements.mappers.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
