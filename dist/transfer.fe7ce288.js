...
var urlTranfer = "".concat("http://localhost:3000/api", "/transfer");
...
var insertTransfer = function insertTransfer(dataTransfer) {
  return _axios.default.post(urlTranfer, dataTransfer).then(function (response) {
    return response.data;
  });
};
...
exports.transferMessage = exports.setAccountOptions = exports.getDate = void 0;
...
var getDate = function getDate() {
  var date = new Date();
  var minDate = "\n  ".concat(date.getFullYear(), "-").concat(date.getMonth() + 1, "-").concat(date.getDate());
  document.getElementById('date').setAttribute('min', minDate);
};
exports.getDate = getDate;
var transferMessage = function transferMessage() {
...
},{}],"pages/transfer/tranfer.validation.js":[function(require,module,exports) {
"use strict";
...
var _tranfer = require("./tranfer.validation");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys(Object(source), !0).forEach(function (key) { _defineProperty(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
function _defineProperty(obj, key, value) { key = _toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
(0, _transfer.getAccountList)().then(function (accountList) {
  transfer = _objectSpread(_objectSpread({}, transfer), {}, {
    accountID: (0, _transfer2.setAccountOptions)(accountList, params.id)
  });
  (0, _transfer2.getDate)();
});
(0, _helpers.onUpdateField)('select-account', function (event) {
  ...
  _tranfer.formValidation.validateField('accountID', transfer.accountID).then(function (result) {
...
(0, _helpers.onUpdateField)('iban', function (event) {
  ...
  _tranfer.formValidation.validateField('iban', transfer.iban).then(function (result) {
...
(0, _helpers.onUpdateField)('name', function (event) {
  ...
  _tranfer.formValidation.validateField('name', transfer.name).then(function (result) {
...
(0, _helpers.onUpdateField)('amount', function (event) {
  ...
  _tranfer.formValidation.validateField('amount', transfer.amount).then(function (result) {
...
(0, _helpers.onUpdateField)('concept', function (event) {
  ...
  _tranfer.formValidation.validateField('concept', transfer.concept).then(function (result) {
...
(0, _helpers.onUpdateField)('notes', function (event) {
  ...
  _tranfer.formValidation.validateField('notes', transfer.notes).then(function (result) {
...
(0, _helpers.onUpdateField)('date', function (event) {
  ...
  _tranfer.formValidation.validateField('date', transfer.date).then(function (result) {
...
(0, _helpers.onUpdateField)('email', function (event) {
  ...
  _tranfer.formValidation.validateField('email', transfer.email).then(function (result) {
    (0, _helpers.onSetError)('email', result);
  });
});
(0, _helpers.onSubmitForm)('transfer-button', function () {
  _tranfer.formValidation.validateForm(transfer).then(function (result) {
    (0, _helpers.onSetFormErrors)(result);
    if (result.succeeded) {
      (0, _transfer.insertTransfer)(transfer).then(function () {
        (0, _transfer2.transferMessage)();
        setTimeout(function () {
...
},{"./transfer.api":"pages/transfer/transfer.api.js","./transfer.helpers":"pages/transfer/transfer.helpers.js","../../core/router":"core/router/index.js","../../common/helpers":"common/helpers/index.js","./tranfer.validation":"pages/transfer/tranfer.validation.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
